...
@InjectViewState
public class ProductDepositsPresenter extends MvpPresenter<ProductItemsView<DepositProduct>> {

    private final Router router;
    private final AuthService authService;
    private final CompositeDisposable compositeDisposable = new CompositeDisposable();

    @Inject ProductDepositsPresenter(final Router router, final AuthService authService) {
        this.router = router;
    ...
    void getProducts() {
        compositeDisposable.add(
            authService
                .getDepositProducts(new RequestInfoRequest(Utils.getCommonRequest()))
    ...
    void goToProductDetails(@NonNull DepositProduct product) {
        ...
        p.type = Constants.ProductTypes.DEPOSIT;
