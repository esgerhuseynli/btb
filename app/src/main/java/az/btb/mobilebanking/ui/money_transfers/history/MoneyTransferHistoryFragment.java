...
public class MoneyTransferHistoryFragment extends Fragment<FragmentMoneyTransferSearchBinding> implements MoneyTransferHistoryView {

    private String searchText;

    @InjectPresenter MoneyTransferHistoryPresenter presenter;

    @ProvidePresenter MoneyTransferHistoryPresenter providePresenter() {
        return Toothpick.openScope(SERVER_SCOPE).getInstance(MoneyTransferHistoryPresenter.class);
    }

    public MoneyTransferHistoryFragment() {
        super(R.layout.fragment_money_transfer_search);
    }

    @NonNull
    public static MoneyTransferHistoryFragment getInstance() {
        return new MoneyTransferHistoryFragment();
    }
