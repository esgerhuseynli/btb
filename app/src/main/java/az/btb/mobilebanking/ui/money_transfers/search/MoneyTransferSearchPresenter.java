...
@InjectViewState
public class MoneyTransferSearchPresenter extends MvpPresenter<MoneyTransferSearchView> {

    private final Router router;
    private final AuthService authService;
    private final CompositeDisposable compositeDisposable = new CompositeDisposable();

    @Inject MoneyTransferSearchPresenter(final Router router, final AuthService authService) {
        this.router = router;
