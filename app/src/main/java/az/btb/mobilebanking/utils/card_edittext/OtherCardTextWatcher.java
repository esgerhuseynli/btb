package az.btb.mobilebanking.utils.card_edittext;
...
public class OtherCardTextWatcher extends CreditCardBaseTextWatcher implements TextWatcher {
    ...
    public OtherCardTextWatcher(CreditCardEditText editText, LinearLayout nextButton) {
        mEditText = editText;
    ...
    public void afterTextChanged(Editable s) {
        ...
        if (nextButton != null) {
            nextButton.setEnabled(s.length() == 19);
            nextButton.setClickable(s.length() == 19);
        }
