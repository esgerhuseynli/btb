...
public class ReferenceProduct {
    ...
    private @Constants.ProductTypes int referenceType;

    public void setReferenceType(@Constants.ProductTypes int referenceType) {
        this.referenceType = referenceType;
    }

    public @Constants.ProductTypes int getReferenceType() {
    ...
    public void setProductTariff(String productTariff) {
